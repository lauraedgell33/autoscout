      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto px-4 py-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-6 sm:mb-8 flex items-center gap-2">
            <SettingsIcon className="w-7 h-7 sm:w-8 sm:h-8 text-orange-500" />
            Settings
          </h1>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-orange-500 border-gray-300 rounded focus:ring-orange-500"
                    />
                    <span className="text-sm text-gray-700">Price Drops on Favorites</span>
                  </label>
          ...
          <div className="flex gap-4 mb-6">
            <Button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white font-semibold flex-1 sm:flex-initial"
            >

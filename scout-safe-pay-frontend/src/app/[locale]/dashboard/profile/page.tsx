    ...
    <ProtectedRoute>
      <DashboardLayout>
        <div className="max-w-4xl mx-auto px-4 py-6">
            ...
            <form onSubmit={handleProfileSubmit}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Badge className="bg-primary-900 hover:bg-primary-950 text-white text-xs px-3 py-1.5 capitalize">
                    {user?.role}
                  </Badge>
                </div>
                ...
                <Button
                  type="submit"
                  className="bg-accent-500 hover:bg-accent-600 text-white text-sm font-semibold rounded-xl w-full sm:w-auto"
                >
          ...
          <Card className="p-4 sm:p-5 mb-5 rounded-2xl border border-gray-100">
            ...
            <form onSubmit={handlePasswordSubmit}>
              <div className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="bg-primary-900 hover:bg-primary-950 text-white text-sm font-semibold rounded-xl w-full sm:w-auto"
                >
          ...
          {/* Account Info */}
          <Card className="p-4 sm:p-5 rounded-2xl border border-gray-100">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                ...
                <Badge className={user?.email_verified_at ? 'bg-green-500 hover:bg-green-600 text-xs' : 'bg-accent-500 hover:bg-accent-600 text-xs'}>

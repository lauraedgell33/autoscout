            ...
            <div className="space-y-8 text-gray-700">
              ...
              <section>
                ...
                <div className="ml-9 space-y-4">
                  ...
                  <p>© 2026 AutoScout24 SafeTrade GmbH. All rights reserved.</p>
                </div>
              </section>

              <section className="pt-8 border-t border-gray-200">
                <p className="text-sm text-gray-500">{t('pages.imprint.last_updated')}: January 2026</p>
              </section>
            </div>
          </div>
        </div>

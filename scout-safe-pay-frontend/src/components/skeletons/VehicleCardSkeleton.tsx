...
export function VehicleCardSkeleton({ className }: VehicleCardSkeletonProps) {
  return (
    ...
    >
      ...
      <div className="relative bg-gray-200 h-56 w-full shimmer">
        {/* Badge placeholders */}
        <div className="absolute top-3 left-3 flex gap-2">
          <div className="h-6 w-16 bg-gray-300 rounded-full shimmer" />
          <div className="h-6 w-20 bg-gray-300 rounded-full shimmer" />
        </div>
        {/* Favorite button placeholder */}
        <div className="absolute top-3 right-3 h-10 w-10 bg-gray-300 rounded-full shimmer" />
      </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="space-y-2">
          <div className="h-6 bg-gray-200 rounded w-4/5 shimmer" />
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <div className="h-3 bg-gray-200 rounded w-12 shimmer" />
            <div className="h-7 bg-gray-200 rounded w-28 shimmer" />
          </div>
          <div className="h-10 bg-gray-200 rounded w-32 shimmer" />
        </div>
      </div>
